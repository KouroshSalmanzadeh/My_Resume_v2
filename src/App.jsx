          ...
          <div className="skills" id="skills" ref={skillsRef}>
            ...
            <div className="container">
              <div className="main-box-skills reveal-top" onClick={openBoxSkills}>
                ...
                <svg className='w-4 h-4 xl:w-10 xl:h-10 animate-bounce mt-4 absolute bottom-0' xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="currentColor" version="1.1" id="Layer_1" viewBox="0 0 330 330" xml:space="preserve">
